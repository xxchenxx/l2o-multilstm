CUDA_VISIBLE_DEVICES=0 nohup python train_rnnprop.py --problem cifar10_resnet20_rp --save_path resnet20_rp_train_rnnprop --if_cl=False --if_mt=False --num_epochs=10000 --num_steps=100 > 0713_resnet20_rp_train_rnnprop_GPU0.out &
